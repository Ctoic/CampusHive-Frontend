      ...
      <div className="container mx-auto px-4">
        <div className="flex w-full flex-col gap-16 overflow-hidden rounded-xl bg-[#111111] border border-gray-800/50 p-8 md:p-16 lg:flex-row lg:items-center">
          <div className="flex-1 space-y-4">
            <Badge className="bg-[#60a5fa] text-black hover:bg-[#60a5fa]/90 transition-colors duration-300">
              Get Started
            </Badge>
          ...
          <div className="flex shrink-0 flex-col gap-4 sm:flex-row">
            <Button 
              variant="outline" 
              className="border-[#60a5fa]/20 text-white hover:bg-[#60a5fa]/10 hover:text-[#60a5fa] transition-all duration-300"
            >
              Learn More
            </Button>
            <Link to="/signup">
              <Button 
                className="bg-[#60a5fa] text-black hover:bg-[#60a5fa]/90 transition-all duration-300"
              >
                Get Started Now
              </Button>
            </Link>
